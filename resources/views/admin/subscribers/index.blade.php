...
@endsection
@section('content')
@include('admin.inc.breadcrumb',['page' => 'Subscribers'])

<div class="container-fluid" style="padding:30px;min-height:100vh">
  <div class="card mb-3">
              <div class="card-header">
                <h3><i class="fa fa-users"></i> Subscribers details</h3>
                As an admin you can manage your subscribers!
              </div>
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.deleteProduct', function () {
        var product_id = $(this).data("id");
        var url = "{{url('subscriptions/delete/')}}/" + product_id;
        {
            delete_this(url);
        }
    });
